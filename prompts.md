...
This file documents the main AI-assisted prompts and agent interactions used during the development of the IssueFlow backend assignment.

## AI Models and Tools Used

During the development process, the following AI models/tools were used:

- GPT Codex 3.2
- Gemini 3.1 Pro

The prompts below reflect the main AI-assisted steps used for configuration, implementation, debugging, testing, and documentation.
...
# Section B: Users Module

## 4. Users Module Implementation
...
# Section C: Authentication Module

## 6. Authentication - Login

> Create a new `AuthModule` to handle JWT-based authentication. Please follow these exact steps:
>
...
## 7. Authentication - JWT Protection and `/auth/me`

> We successfully completed part 1 and the login route works perfectly! Let's implement part 2 to protect our routes and add the `/auth/me` endpoint. Please include clean English comments (`//`) at key points:
>
...
> Let's implement the final part of the authentication chapter: the Logout functionality. Please include clean, informative comments in English (`//`):
>
...
## 9. Projects Module Implementation

> We are starting Stage 2: Projects Module. Please create the `ProjectsModule` with TypeORM and JWT protection. Follow these exact steps and ensure you include clean, educational comments in English (`//`) at key logic points and complex architecture parts to make the code easy to follow:
>
...
# Section E: Tickets Module

## 10. Tickets Module - Core Implementation

> Generate the core `TicketsModule` for the NestJS application using TypeORM and PostgreSQL. This is Part 1 of the module creation. Do NOT implement CSV export/import yet.
>
...
# Section F: CSV Import and Export

## 11. CSV Import/Export - Helper Approach

> I want to implement Part 2 (CSV Import/Export) using a clean, separated approach (the "half-half" helper approach) so that `tickets.service.ts` doesn't become bloated and remains highly testable.
>
...
## 12. CSV Import Alignment with README
...
# Section G: Extended Features

## 13. Soft Delete and Restore

> Implement the missing endpoints and service methods for the "Soft Delete & Restore" feature based on the project README contract.
>
...
## 14. Auto Assignment by Workload

> Implement Feature 3.8: Auto Assignment to Users by Workload. Make the exact following changes:
>
...
> Create the Audit Logs module matching the README specifications.
...
## 16. Ticket Dependencies - Database Foundation

> Implement the database foundation for Feature 3.2 (Ticket Dependencies).
...
## 17. Attachment Management - Database Infrastructure

> Create the database infrastructure for Feature 3.3 (Attachment Management). Do not add any service logic or controller endpoints yet. Add clear inline comments in English.
>
...
## 18. Auto-Scheduling Escalation Level on Tickets

> Implement "Feature 3.7 Auto-Scheduling Escalation Level on Tickets" in the existing NestJS application. Add clear, descriptive comments to all logically complex sections.
>
> Requirements:
...
## 19. Auto-Scheduling Escalation Tests

> Based on the current test file and the recent implementation of Feature 3.7, generate ONLY the new `describe` block for "Feature 3.7 - Auto-Scheduling Escalation Level on Tickets" tests. Provide the code as a clean block in the chat window so I can append it manually. Do not change any existing tests.
>
